...
public class PAPlan implements Serializable {
	private static final long serialVersionUID = -51048438162290L;
	...
	public String toString() {
		...
		for (int i = 0; i<this.plannedString.size();i++){
			total = total + " "+ this.plannedString.get(i)
					+ " [" + this.startTimes.get(i) + "," + this.endTimes.get(i) + "];\n";
		}
		return total;
	}
...
//					sortByStartTime();
	...
	public int getNumOfEvents() {
		return this.plannedString.size();
	}
}